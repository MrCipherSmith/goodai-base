...
- `core/opus-5-5-prompting.mdc`: Prompting and workflow standards for Claude Opus 5.5+ — no reasoning instructions, finish-line task framing, stopping rules, long-run state, blockers-first acceptance.
