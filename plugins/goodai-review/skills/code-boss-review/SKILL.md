...
3. **Стиль/принципы boss**: ревью строго по `~/goodai-base/rules/core/code-review-boss-profile.mdc` (разделы правил и промпт).
...
Применяй чек-лист и промпт из `~/goodai-base/rules/core/code-review-boss-profile.mdc`. Ключевые акценты boss:
...
This skill covers **boss-style code review** — direct, logic-first, no-fluff feedback following `code-review-boss-profile.mdc`.
