...
description: "Relentless interactive plan gatekeeper. Stress-tests design choices, architecture, API contracts, state management, and edge cases. Proposes Architectural Decisions (ADR) in the final response status block."
triggers:
  - "/plan-gatekeeper"
  - "plan-gatekeeper"
  - "gatekeep plan"
