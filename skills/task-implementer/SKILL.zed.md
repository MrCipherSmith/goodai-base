...
- Read `CONTEXT_PATH` (e.g., `~/goodea/goodai-base/jobs/<job-name>/ai/context.md`)
...
- OpenCode: `~/goodea/goodai-base/rules/core/<rule>.mdc`
- Cursor: `.cursor/rules/core/<rule>.mdc`
- Codex: `~/goodea/goodai-base/rules/core/<rule>.mdc`
