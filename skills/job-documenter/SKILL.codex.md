...
Sub-agent responsible for creating and maintaining structured job documentation in `~/goodea/goodai-base/jobs/`. Called exclusively by `job-orchestrator` to persist the lifecycle of orchestrated tasks — from initial plan through analysis, implementation, review, and final report.
...
7. **Return result:**
   ...
   DOCUMENTER_RESULT:
     ...
     job_path: ~/goodea/goodai-base/jobs/<JOB_NAME>
