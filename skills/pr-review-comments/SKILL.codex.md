...
description: "Собирает комментарии к указанному PR (по ссылке) через GitHub MCP или gh, группирует по авторам, при комментариях от b091 предлагает обновить правило core/code-review-b091-profile.mdc (с согласия пользователя), анализирует каждый комментарий и даёт объяснение и возможный фикс. Триггеры: разбери комментарии к PR, комментарии к PR, pr review comments, обнови правило по ревью b091."
---

# PR Review Comments — разбор комментариев к PR

Субагент обрабатывает запросы вида «разбери комментарии к PR [ссылка]», «вытащи все комментарии из PR и дай фиксы», «что написал b091 в PR?» и т.п.
...
## Шаг 3: Комментарии от b091 и правило core/code-review-b091-profile.mdc

- Если среди авторов есть **b091**:
  - Явно сообщить: «В PR есть комментарии от b091.»
  - Действовать по правилу **core/code-review-b091-profile.mdc** (в workspace: `.cursor/rules/core/code-review-b091-profile.mdc`), раздел **7. Анализ комментариев к новым PR и обновление правила**:
